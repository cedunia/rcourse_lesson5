...
incumbent_histogram_full.plot <- ggplot(data_figs, 
                                        aes(x = perc_votes_incumbent,
...
incumbent_histogram_sum.plot <- ggplot(data_figs_state_sum, 
...
# Boxplot
incumbent_boxplot.plot <- ggplot(data_figs_state_sum, 
                                 aes(x = civil_war, 
...
# Barplot
incumbent_barplot.plot <- ggplot(data_figs_sum, 
                                 aes(x = civil_war,
                                     y = mean,
                                     fill = incumbent_party)) +
